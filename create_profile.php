	            ...
	            <div class="col-sm-4 form_box2">
	                   <div class="select-block1">
	                    <select name="state">
		                    ...
		                    <option value="Taminadu">Kerala</option>
		                    <option value="Karnataka">UP</option>
		                    <option value="Andhrapradesh">Gujarath</option>  
	                    </select>
	                  </div>
	                 </div>
	                 <div class="col-sm-4 form_box1">
	                   <div class="select-block1">
	                    <select name="district">
		                    ...
		                    <option value="Trivandrum">Mangalore</option>
		                    <option value="Kollam">Udupi</option>
		                    <option value="Pathanamthitta">Bantwal</option>
		      ...
		      <label for="edit-name">Mother Tounge<span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                <select name="mothertounge">
	                    ...
	                    <option value="Hindi">Tulu</option> 
